...
Shader "S1"
{
	Properties
	{
		...
		_Dissolve("Dissolve", Range( 0 , 1.05)) = 0.3716907
		[ASEEnd]_EdgeColor("EdgeColor", Color) = (0.8867924,0.6307939,0.6307939,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float temp_output_5_0 = step( _Dissolve , ( tex2DNode2.r + 0.02 ) );
				float temp_output_9_0 = ( temp_output_5_0 - step( _Dissolve , tex2DNode2.r ) );
				float4 lerpResult14 = lerp( tex2DNode1 , ( tex2DNode1.a * temp_output_9_0 * _EdgeColor ) , temp_output_9_0);
				float4 appendResult13 = (float4((lerpResult14).rgba.rgb , ( tex2DNode1.a * temp_output_5_0 )));
				
				surfaceDescription.Color = appendResult13.xyz;
...
ASEEND*/
//CHKSM=D236E2A96193A6B4A7A33D763F19F28CF295FEF6